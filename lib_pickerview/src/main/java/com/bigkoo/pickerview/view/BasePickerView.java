...
//        int tempWidth = (int)(dm.widthPixels * 0.86);
        int tempWidth = (int)(dm.widthPixels * 1);
        int widthUpper = dip2px(context,402);
        int widthLow = dip2px(context,267);
        if (tempWidth > widthUpper){
            tempWidth = widthUpper;
        }else if (tempWidth < widthLow){
            tempWidth = widthLow;
        }
        p.width = tempWidth;
